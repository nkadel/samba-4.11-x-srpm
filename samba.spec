...
Source0:        https://download.samba.org/pub/samba/%{?pre_release:/}samba-%{version}%{pre_release}.tar.gz#/samba-%{version}%{pre_release}.tar.gz
...
- Do not require full systemd for tmp files handling in samba-common
